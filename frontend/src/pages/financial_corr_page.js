...
const FinancialCorrPage = () => {
  ...
  const handleSubmit = async () => {
    setIsLoading(true);
    try {
      const response = await fetch('http://127.0.0.1:8000/api/financial/corr', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold mb-6">金融文本纠错 💰</h1>
...
export default FinancialCorrPage; 